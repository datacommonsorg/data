...
def main():
    ...
    try:
        ...
        file_util.file_copy(
            f'gs://unresolved_mcf/world_bank/datasets/observations/historical_retained/{historical_file}',
            f'{output}/{historical_file}')
        expected_output_files = [
            'bq-results-20250423.csv', 'transformed_data_for_all_final.csv'
        ]
