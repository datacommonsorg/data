...
interest = [
    "DT.INT.BLAT.CD", "DT.INT.BLTC.CD", "DT.INT.BLTC.CD", "DT.INT.DLXF.CD",
    "DT.INT.DPNG.CD", "DT.INT.DPPG.CD", "DT.INT.MIBR.CD", "DT.INT.MIDA.CD",
    "DT.INT.MLAT.CD", "DT.INT.MLTC.CD", "DT.INT.OFFT.CD", "DT.INT.PBND.CD",
    "DT.INT.PCBK.CD", "DT.INT.PNGB.CD", "DT.INT.PNGC.CD", "DT.INT.PROP.CD",
    "DT.INT.PRVT.CD"
]
...
principal = [
    ...
    "DT.AMT.PCBK.CD", "DT.AMT.PROP.CD", "DT.AMT.DPNG.CD", "DT.AMT.PNGB.CD",
    "DT.AMT.PNGC.CD"
]

disbursed = [
    "DT.DOD.DLXF.CD", "DT.DOD.DPPG.CD", "DT.DOD.DPPG.CD", "DT.DOD.OFFT.CD",
    "DT.DOD.MLAT.CD", "DT.DOD.MIBR.CD", "DT.DOD.MIDA.CD", "DT.DOD.MLTC.CD",
    "DT.DOD.BLAT.CD", "DT.DOD.BLTC.CD", "DT.DOD.PRVT.CD", "DT.DOD.PBND.CD",
    "DT.DOD.PCBK.CD", "DT.DOD.PROP.CD", "DT.DOD.DPNG.CD", "DT.DOD.PNGB.CD",
    "DT.DOD.PNGC.CD"
]

currency = [
    "DT.CUR.DMAK.ZS", "DT.CUR.EURO.ZS", "DT.CUR.EURO.ZS", "DT.CUR.JYEN.ZS",
