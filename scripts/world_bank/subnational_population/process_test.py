    ...
    def __init__(self, methodName: str = ...) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            CLEANED_CSV_FILE_PATH = os.path.join(tmp_dir,
                                                 "subnational_test.csv")
            MCF_FILE_PATH = os.path.join(tmp_dir, "subnational_test.mcf")
            TMCF_FILE_PATH = os.path.join(tmp_dir, "subnational_test.tmcf")

            base = Subnational(self.ip_data, CLEANED_CSV_FILE_PATH,
