  ...
  """
    ...
    def __init__(self,
        ...
        try:
            ...
            logging.fatal(
                "Please ensure that the path to the JSON spec is correct.")
    ...
    def _get_outputs(self):
        ...
        f.close()
        logging.info(
            f"""processing of subject table is complete: the summary of the
    ...
    def _process_dir(self, input_dir_path):
        ...
        try:
            ...
            logging.fatal(
                """ensure input path is that of directory with dataset files,
