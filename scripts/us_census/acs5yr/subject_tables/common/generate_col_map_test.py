...
class GenerateColMapTest(unittest.TestCase):
   ...
   def test_generating_column_map_from_csv(self):
   	...
   	input_csv_path = os.path.join(base_path, "./testdata/ACSST5Y2013_S2702.csv")
   	expected_map_path = os.path.join(base_path, "./testdata/column_map_from_zip_expected.json")
   ...
   def test_generating_column_map_from_zip(self):
   	...
   	generated_col_map = process_zip_file(input_zip_path, spec_path, write_output=False)
