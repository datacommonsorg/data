...
def find_columns_with_token(column_list: list, token: str, delimiter: str = '!!') -> list:
...
def replace_token_in_column(cur_column: str, old_token: str, new_token: str, delimiter: str='!!') -> str:
...
def get_columns_by_token_count(column_list: list, delimiter: str = '!!') -> dict:
  ret_dict = {}
  for cur_column in column_list:
...
def guess_total_columns_from_zip_file(zip_path: str, ignore_token_list: list, year_list: list) -> dict:
...
def total_columns_from_csvreader(csv_reader: Any, ignore_token_list: list) -> list:
  total_columns = []
...
def yearwise_columns_from_zip_file(zip_path: str, spec_dict: dict, year_list: list, delimiter: str = '!!') -> dict:
  zip_path = os.path.expanduser(zip_path)
  ret_dict = {}
...
def get_census_rows_by_column_by_type(rows_by_column: dict, delimiter: str = '!!') -> dict:
...
def get_column_total_status(totals_by_column: dict, rows_by_column_type: dict) -> dict:
  ret_dict = {}
...
def create_denominators_section(long_config_path: str, delimiter: str = '!!') -> None:
