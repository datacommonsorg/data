...
sys.path.append(os.path.join(
    _SCRIPT_PATH, '.'))  # for statvar_dcid_generator
...
def process_csv_file(csv_file_path: str,
                     ...
                     delimiter: str = '!!',
                     header_row: int = 1,
                     replace_inplace: bool = True) -> dict:
    """
    Given a csv census data file, the function builds a column map for each year
      ...
      Args:
        ...
        replace_inplace: Boolean flag to allow overwritng pvs with values in inferredSpec or dependent PVs. (default=True)
