...
flags.DEFINE_string(
    'input_path', None,
    'Path to input directory with downloaded zip files, extracted directory or csv file from the census.data.gov site.'
)
...
flags.DEFINE_string(
    'years', 'all',
    'Set all if all years in the dataset needs percent to count conversion, else specify the specific years separated by commas like years=2010,2011 (default="all")'
)
