...
URLS_JSON_PATH = "Nationals/national_2000_2010.json"
URLS_JSON = None
...
df.rename(columns={'Unnamed: 0': 'SRH', 'Unnamed: 13': '2010'}, inplace=True)
...
for i in range(len(df)):
    if df.loc[i, 'SRH'].replace('.', '') in ['BOTH SEXES', 'MALE', 'FEMALE']:
...
# dropping unwanted columns
df.drop(columns=[
    'LOCATION', 'OneRace__BothSexes', 'White__BothSexes', 'Black__BothSexes',
    'Aian__BothSexes', 'Asian__BothSexes', 'Nhpi__BothSexes',
    'TwoOrMoreRaces__BothSexes', 'NotHispanic', 'OneRace_NotHispanic_BothSexes',
    'White_NotHispanic_BothSexes', 'Black_NotHispanic_BothSexes',
    'Aian_NotHispanic_BothSexes', 'Asian_NotHispanic_BothSexes',
    'Nhpi_NotHispanic_BothSexes', 'TwoOrMoreRaces_NotHispanic_BothSexes',
    'Hispanic', 'OneRace_Hispanic_BothSexes', 'White_Hispanic_BothSexes',
    ...
    'Black_NotHispanic_Male', 'Aian_NotHispanic_Male', 'Asian_NotHispanic_Male',
    'Nhpi_NotHispanic_Male', 'TwoOrMoreRaces_NotHispanic_Male', 'Hispanic',
    'OneRace_Hispanic_Male', 'White_Hispanic_Male', 'Black_Hispanic_Male',
    'Aian_Hispanic_Male', 'Asian_Hispanic_Male', 'Nhpi_Hispanic_Male',
    ...
    'TwoOrMoreRaces_NotHispanic_Female', 'Hispanic', 'OneRace_Hispanic_Female',
    'White_Hispanic_Female', 'Black_Hispanic_Female', 'Aian_Hispanic_Female',
...
df.to_csv("nationals_result_2000_2010.csv")
