...
_YEARWISE_CONFIG = {
    '2020': {
        'type': 'xls',
        'path': '../source_data/2020/table_14.xlsx',
        'args': {
            'header': 6,
            'skipfooter': 3
        }
    ...
    '2019': {
        'type': 'xls',
        'path': '../source_data/2019/table_14.xls',
        'args': {
            'header': 5,
            'skipfooter': 3
        }
    ...
    '2018': {
        'type': 'xls',
        'path': '../source_data/2018/table_14.xls',
        'args': {
            'header': 5,
            'skipfooter': 3
        }
    ...
    '2017': {
        'type': 'xls',
        'path': '../source_data/2017/table_14.xls',
        'args': {
            'header': 5,
            'skipfooter': 3,
    ...
    '2016': {
        'type': 'xls',
        'path': '../source_data/2016/table_14.xls',
        'args': {
            'header': 5,
            'skipfooter': 3
        }
    ...
    '2015': {
        'type': 'xls',
        'path': '../source_data/2015/table_14.xls',
        'args': {
            'header': 5,
            'skipfooter': 3
        }
    ...
    '2014': {
        'type': 'xls',
        'path': '../source_data/2014/table_14.xls',
        'args': {
            'header': 5,
            'skipfooter': 3
        }
    ...
    '2013': {
        'type': 'xls',
        'path': '../source_data/2013/table_14.xls',
        'args': {
            'header': 5,
            'skipfooter': 3,
            'usecols': list(range(0, 8))
    ...
    '2012': {
        'type': 'xls',
        'path': '../source_data/2012/table_14.xls',
        'args': {
            'header': 5,
            'skipfooter': 3
        }
    ...
    '2011': {
        'type': 'xls',
        'path': '../source_data/2011/table_14.xls',
        'args': {
            'header': 3,
            'skipfooter': 3
        }
    ...
    '2010': {
        'type': 'xls',
        'path': '../source_data/2010/table_14.xls',
        'args': {
            'header': 3,
            'skipfooter': 3
        }
    ...
    '2009': {
        'type': 'xls',
        'path': '../source_data/2009/table_14.xls',
        'args': {
            'header': 3,
            'skipfooter': 3
        }
    ...
    '2008': {
        'type': 'xls',
        'path': '../source_data/2008/table_14.xls',
        'args': {
            'header': 3,
            'skipfooter': 3
        }
    ...
    '2007': {
        'type': 'xls',
        'path': '../source_data/2007/table_14.xls',
        'args': {
            'header': 3,
            'skipfooter': 3
        }
...
def _clean_dataframe(df: pd.DataFrame, year: str):
    ...
    if year in ['2020']:
        df.columns = [
            'state', 'agency type', 'agency', 'agency unit', '1st quarter',
        ...
        df.columns = [
            'state', 'agency type', 'agency', '1st quarter', '2nd quarter',
            '3rd quarter', '4th quarter', 'population'
        ]
