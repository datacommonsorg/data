statvar_col = {
    'Nutrition__Multivitamin use ≥4 times a week during the month before pregnancy':
    ...
    'Substance Use__Hookah use in the last 2 years':
        'HookahInLast2Years',
    'Substance Use__Heavy drinking (≥8 drinks a week) during the 3 months before pregnancy':
        'HeavyDrinking3MonthsBeforePregnancy',
    'Intimate Partner Violence (IPV)¥__Experienced IPV during the 12 months before pregnancy by a2.5 husband or partner and/or by an ex-husband or ex-partner':
        'IntimatePartnerViolenceByCurrentOrExPartnerOrCurrentOrExHusband12MonthsBeforePregnancy',
    'Intimate Partner Violence (IPV)¥__Experienced IPV during the 12 months before pregnancy by a husband or partner and/or an ex-husband or partner':
        'IntimatePartnerViolenceByCurrentOrExPartnerOrCurrentOrExHusband12MonthsBeforePregnancy',
    'Intimate Partner Violence (IPV)¥__Experienced IPV during pregnancy by a husband or partner and/or an ex-husband or partner':
        'IntimatePartnerViolenceByCurrentOrExPartnerOrCurrentOrExHusbandDuringPregnancy',
    'Intimate Partner Violence (IPV)¥__Experienced IPV during the 12 months before pregnancy by a husband or partner and/or by an ex-husband or ex-partner':
        'IntimatePartnerViolenceByCurrentOrExPartnerOrCurrentOrExHusband12MonthsBeforePregnancy',
    'Intimate Partner Violence (IPV)¥__Experienced IPV during pregnancy by a husband or partner and/or by an ex-husband or ex-partner':
        'IntimatePartnerViolenceByCurrentOrExPartnerOrCurrentOrExHusbandDuringPregnancy',
    ...
    'Health Care Services__Had a flu shot in the 12 months before delivery':
        'FluShot12MonthsBeforePregnancy',
    ...
    'Postpartum†† Family Planning_Highly effective contraceptive methods_Male or female sterilization':
        'MaleOrFemaleSterilization',
    'Postpartum†† Family Planning_Highly effective contraceptive methods_Long-acting reversible contraceptive method§§':
        'LongActingReversibleContraceptiveMethods',
    'Postpartum†† Family Planning__Moderately effective contraceptive methods§§':
    ...
    'Oral Health__Teeth cleaned during pregnancy by a dentist or dentalhygienist':
        'TeethCleanedByDentistOrHygienistDuringPregnancy',
    'Oral Health__Teeth cleaned during pregnancy by a dentist or dental hygienist':
        'TeethCleanedByDentistOrHygienistDuringPregnancy',
