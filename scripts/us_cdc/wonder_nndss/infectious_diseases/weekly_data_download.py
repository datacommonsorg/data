...
def extract_table_from_link(table_url:str,filename:str, output_path:str)->None:
	"""
	"""
	num_tries = 10
...
def scrape_table_links_from_page(page_url:str, output_path:str)->None:
	"""
	"""
...
def download_weekly_nnds_data_across_years(year_range:str, output_path:str)->None:
	...
	for year in year_range:
		...
		for week in week_range:
			if year < 2017:
				index_url = _WEEKLY_TABLE_2010.format(year=year, week=week)
			else:
				index_url = _WEEKLY_TABLE_2017.format(year=year, week=week)
