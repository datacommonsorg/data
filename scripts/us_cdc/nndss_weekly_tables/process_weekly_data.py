...
FLAGS = flags.FLAGS
flags.DEFINE_string('weekly_nndss_input', './data/nndss_weekly_data', 'Path to the directory with weekly data scrapped from NNDSS')
...
def generate_statvar_map_for_columns(column_list, place_list, _):
...
_PLACE_DCID_DF = pd.read_csv("./data/place_name_to_dcid.csv",
    ...
    # write csv
    cleaned_dataframe = cleaned_dataframe[['observationDate', 'observationAbout', 'observationPeriod', 'variableMeasured', 'value', 'measurementMethod', 'week', 'column_name']]
