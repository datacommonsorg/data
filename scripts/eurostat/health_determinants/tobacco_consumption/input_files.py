...
def download_files(download_directory: str) -> None:
    ...
    files = [
        'hlth_ehis_sk1i.tsv.gz', 'hlth_ehis_sk1e.tsv.gz',
        'hlth_ehis_sk1u.tsv.gz', 'hlth_ehis_sk3e.tsv.gz',
        'hlth_ehis_sk3i.tsv.gz', 'hlth_ehis_sk3u.tsv.gz',
        'hlth_ehis_sk4e.tsv.gz', 'hlth_ehis_sk4u.tsv.gz',
        'hlth_ehis_sk1b.tsv.gz', 'hlth_ehis_sk1c.tsv.gz',
        'hlth_ehis_sk2i.tsv.gz', 'hlth_ehis_sk2e.tsv.gz',
        'hlth_ehis_sk5e.tsv.gz', 'hlth_ehis_sk6e.tsv.gz',
