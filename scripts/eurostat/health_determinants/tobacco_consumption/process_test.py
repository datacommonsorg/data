...
from process import EuroStatTobaccoConsumption
...
class TestProcess(unittest.TestCase):
    ...
    """
    test_data_files = [
        'hlth_ehis_sk1b.tsv', 'hlth_ehis_sk1c.tsv', 'hlth_ehis_sk1e.tsv',
        'hlth_ehis_sk1i.tsv', 'hlth_ehis_sk1u.tsv', 'hlth_ehis_sk2i.tsv',
        'hlth_ehis_sk2e.tsv', 'hlth_ehis_sk3e.tsv', 'hlth_ehis_sk3i.tsv',
        'hlth_ehis_sk3u.tsv', 'hlth_ehis_sk4e.tsv', 'hlth_ehis_sk4u.tsv',
