...
_MODULE_DIR = "/Users/aroravijay/datacommons_euro_phy/data/scripts/eurostat/health_determinants/physical_activity/"
...
_OUTPUT_MCF_FILE_PATH = os.path.join(
    _MODULE_DIR, "output", "eurostat_population_physicalactivity_deno.mcf")
