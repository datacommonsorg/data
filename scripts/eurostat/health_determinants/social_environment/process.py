...
def _socialsupport_by_education_sex(df: pd.DataFrame) -> pd.DataFrame:
    """
    Cleans the file _socialsupport_by_education_sex
...
def _socialsupport_by_deg_of_urbanisation_sex(df: pd.DataFrame) -> pd.DataFrame:
    """
    Cleans the file _socialsupport_by_deg_of_urbanisation_sex
    for concatenation in Final CSV.
...
def _socialsupportassistance_by_education_sex(df: pd.DataFrame) -> pd.DataFrame:
    """
    Cleans the file _socialsupportassistance_by_education_sex
    for concatenation in Final CSV.
...
def _socialsupportassistance_by_deg_of_urbanisation_sex(df: pd.DataFrame)\
    -> pd.DataFrame:
    """
    Cleans the file _socialsupportassistance_by_deg_of_urbanisation_sex
    for concatenation in Final CSV.
...
def _socialsupport_by_countryofbirth_sex(df: pd.DataFrame) -> pd.DataFrame:
    """
    Cleans the file _socialsupport_by_countryofbirth_sex
    for concatenation in Final CSV.
...
def _socialsupport_by_citizen_sex(df: pd.DataFrame) -> pd.DataFrame:
    """
    Cleans the file _socialsupport_by_citizen_sex
    for concatenation in Final CSV.
...
def _socialsupportassistance_by_sex(df: pd.DataFrame) -> pd.DataFrame:
    """
    Cleans the file _socialsupportassistance_by_sex
    for concatenation in Final CSV.
      ...
      """
        ...
        for file_path in self._input_files:
            ...
            file_to_function_mapping = {
                "hlth_ehis_ss1e":
                    _socialsupport_by_education_sex,
                "hlth_ehis_ss1u":
                    _socialsupport_by_deg_of_urbanisation_sex,
                "hlth_ehis_ic1e":
                    _socialsupportassistance_by_education_sex,
                "hlth_ehis_ic1u":
                    _socialsupportassistance_by_deg_of_urbanisation_sex,
                "hlth_ehis_ss1b":
                    _socialsupport_by_countryofbirth_sex,
                "hlth_ehis_ss1c":
                    _socialsupport_by_citizen_sex,
                "hlth_ehis_ss1d":
                    _socialsupportassistance_by_sex
            }
