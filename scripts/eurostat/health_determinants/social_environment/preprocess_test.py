...
from preprocess import EuroStatSocialEnvironment
...
class TestProcess(unittest.TestCase):
    ...
    def __init__(self, methodName: str = ...) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            base = EuroStatSocialEnvironment(self.ip_data, cleaned_csv_file_path
    ...
    def test_mcf_tmcf_files(self):
        ...
        expected_mcf_file_path = os.path.join(
            EXPECTED_FILES_DIR,
            "expected_eurostat_population_socialenvironment.mcf")

        expected_tmcf_file_path = os.path.join(
            EXPECTED_FILES_DIR,
            "expected_eurostat_population_socialenvironment.tmcf")
    ...
    def test_create_csv(self):
        ...
        expected_csv_file_path = os.path.join(
            EXPECTED_FILES_DIR,
            "expected_eurostat_population_socialenvironment.csv")
