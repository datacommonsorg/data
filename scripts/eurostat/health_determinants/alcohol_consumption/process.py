...
def _alcoholconsumption_by_sex_country_of_birth(df: pd.DataFrame)\
    ...
    # providing column names
    columns = [
        'unit,frequenc,sex,age,c_birth,time', 'EU27_2020', 'EU28', 'BE', 'BG',
        'CZ', 'DK', 'DE', 'EE', 'IE', 'EL', 'ES', 'HR', 'IT', 'CY', 'LV', 'LT',
        'LU', 'HU', 'MT', 'AT', 'PL', 'PT', 'RO', 'SI', 'SK', 'FI', 'SE', 'IS',
        'NO', 'UK', 'TR'
    ]
...
def _alcoholconsumption_by_sex_citizen(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # providing column names
    columns = [
        'unit,frequenc,sex,age,citizen,time', 'EU27_2020', 'EU28', 'BE', 'BG',
        'CZ', 'DK', 'DE', 'EE', 'IE', 'EL', 'ES', 'HR', 'IT', 'CY', 'LV', 'LT',
        'LU', 'HU', 'MT', 'AT', 'PL', 'PT', 'RO', 'SI', 'SK', 'FI', 'SE', 'IS',
        'NO', 'UK', 'TR'
    ]
...
def _historical_alcoholconsumption_by_sex_education(df: pd.DataFrame)\
    ...
    # providing column names
    columns = [
        'sex,age,isced11,frequenc,unit,time', 'BE', 'BG', 'CZ', 'EL', 'ES',
...
def _historical_bingedrinking_by_sex_education(df: pd.DataFrame)\
    ...
    # providing column names
    columns = [
        'frequenc,sex,age,isced11,time', 'BE', 'BG', 'CZ', 'EL', 'ES', 'CY',
        'LV', 'HU', 'MT', 'RO', 'SI', 'SK'
    ]
    df.columns = columns
    # spliting the first column to multiple columns
