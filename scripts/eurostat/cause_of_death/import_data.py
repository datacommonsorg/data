...
class EurostatCauseOfDeathImporter:
    ...
    AGE_MAPPING = {'TOTAL': 'Total', 'Y_LT1': 'Less than 1 year', 'Y1-4': 'From 1 to 4 years',
                   'Y5-9': 'From 5 to 9 years', 'Y10-14': 'From 10 to 14 years', 'Y_LT15': 'Less than 15 years',
                   'Y15-19': 'From 15 to 19 years', 'Y15-24': 'From 15 to 24 years', 'Y20-24': 'From 20 to 24 years',
                   'Y_LT25': 'Less than 25 years', 'Y25-29': 'From 25 to 29 years', 'Y30-34': 'From 30 to 34 years',
                   'Y35-39': 'From 35 to 39 years', 'Y40-44': 'From 40 to 44 years', 'Y45-49': 'From 45 to 49 years',
                   'Y50-54': 'From 50 to 54 years', 'Y55-59': 'From 55 to 59 years', 'Y60-64': 'From 60 to 64 years',
                   'Y_LT65': 'Less than 65 years', 'Y65-69': 'From 65 to 69 years', 'Y_GE65': '65 years or over',
                   'Y70-74': 'From 70 to 74 years', 'Y75-79': 'From 75 to 79 years', 'Y80-84': 'From 80 to 84 years',
                   'Y85-89': 'From 85 to 89 years', 'Y_GE85': '85 years or over', 'Y90-94': 'From 90 to 94 years',
    ...
    CAUSE_DICT = {'A-R_V-Y': ['ICD10/A00-Y89'], 'A_B': ['ICD10/A00-B99'], 'A15-A19_B90': ['ICD10/A15-A19', 'ICD10/B90'],
                  ...
                  'C00-D48': ['ICD10/C00-D48'], 'C': ['MalignantNeoplasms'], 'C00-C14': ['ICD10/C00-C14'],
                  'C15': ['ICD10/C15'],
                  'C16': ['ICD10/C16'], 'C18-C21': ['MalignantNeoplasmsOfColon_RectumAndAnus'], 'C22': ['ICD10/C22'],
                  'C25': ['ICD10/C25'], 'C32': ['ICD10/C32'],
                  'C33_C34': ['MalignantNeoplasmsOfTrachea_BronchusAndLung'],
                  'C43': ['ICD10/C43'], 'C50': ['ICD10/C50'], 'C53': ['ICD10/C53'],
                  'C54_C55': ['MalignantNeoplasmsOfCorpusUteriAndUterus_PartUnspecified'],
                  'C56': ['ICD10/C56'], 'C61': ['ICD10/C61'], 'C64': ['ICD10/C64'], 'C67': ['ICD10/C67'],
                  'C70-C72': ['MalignantNeoplasmsOfMeninges_BrainAndOtherPartsOfCentralNervousSystem'],
                  'C73': ['ICD10/C73'], 'C81-C86': ['ICD10/C81-C86'],
                  'C88_C90_C96': ['ICD10/C88', 'ICD10/C90', 'ICD10/C96'],
                  'C91-C95': ['Leukemia'], 'C_OTH': ['OtherMalignantNeoplasms'],
                  'D00-D48': ['InSituNeoplasms_BenignNeoplasmsAndNeoplasmsOfUncertainOrUnknownBehavior'],
                  'D50-D89': ['ICD10/D50-D89'], 'E': ['ICD10/E00-E90'],
                  'E10-E14': ['DiabetesMellitus'],
                  'E_OTH': ['OtherEndocrine_NutritionalAndMetabolicDiseases'], 'F': ['ICD10/F00-F99'],
                  'F01_F03': ['ICD10/F01', 'ICD10/F03'],
                  'F10': ['ICD10/F10'], 'TOXICO': ['DrugDependence_Toxicomania'],
                  'F_OTH': ['OtherMentalAndBehaviouralDisorders'],
                  'G_H': ['ICD10/G00-H95'], 'G20': ['ICD10/G20'], 'G30': ['ICD10/G30'],
                  'G_H_OTH': ['OtherDiseasesOfTheNervousSystemAndTheSenseOrgans'],
                  'I': ['ICD10/I00-I99'], 'I20-I25': ['ICD10/I20-I25'], 'I21_I22': ['ICD10/I21', 'ICD10/I22'],
                  'I20_I23-I25': ['ICD10/I20', 'ICD10/I23-I25'],
                  'I30-I51': ['ICD10/I30-I51'], 'I60-I69': ['ICD10/I60-I69'],
                  'I_OTH': ['OtherDiseasesOfTheCirculatorySystem'],
                  'J': ['ICD10/J00-J99'], 'J09-J11': ['ICD10/J09-J11'],
                  'J12-J18': ['Pneumonia'],
                  'J40-J47': ['ICD10/J40-J47'], 'J45_J46': ['Asthma'],
                  'J40-J44_J47': ['ICD10/J40-J44', 'ICD10/J47'],
                  'J_OTH': ['OtherDiseasesOfTheRespiratorySystem'], 'K': ['ICD10/K00-K93'],
                  'K25-K28': ['PepticUlcer'],
                  'K70_K73_K74': ['ChronicLiverDiseaseAndCirrhosis'],
                  'K72-K75': ['ICD10/K72-K75'],
                  'K_OTH': ['OtherDiseasesOfTheDigestiveSystem'], 'L': ['ICD10/L00-L99'],
                  'M': ['ICD10/M00-M99'],
                  'RHEUM_ARTHRO': ['ICD10/M05-M06', 'ICD10/M15-M19'],
                  'M_OTH': ['OtherDiseasesOfTheMusculoskeletalSystemAndConnectiveTissue'],
                  'N': ['ICD10/N00-N99'], 'N00-N29': ['ICD10/N00-N29'],
                  'N_OTH': ['OtherDiseasesOfTheGenitourinarySystem'],
                  'O': ['ICD10/O00-O99'], 'P': ['ICD10/P00-P96'], 'Q': ['ICD10/Q00-Q99'], 'R': ['ICD10/R00-R99'],
                  'R95': ['ICD10/R95'],
                  'R96-R99': ['ICD10/R96-R99'],
                  'R_OTH': ['OtherSymptoms_SignsAndAbnormalClinicalAndLaboratoryFindings'],
                  'V01-Y89': ['ICD10/V01-Y89'], 'ACC': ['Accidents(UnintentionalInjuries)'],
                  'V_Y85': ['TransportAccidents'], 'ACC_OTH': ['Eurostat_OtherAccidents'],
                  'W00-W19': ['ICD10/W00-W19'], 'W65-W74': ['ICD10/W65-W74'],
                  'X60-X84_Y870': ['IntentionalSelf-Harm(Suicide)'],
                  'X40-X49': ['AccidentalPoisoningAndExposureToNoxiousSubstances'],
                  'X85-Y09_Y871': ['Assault(Homicide)'], 'Y10-Y34_Y872': ['Eurostat_EventOfUndeterminedIntent'],
    ...
    def translate_column(self, column):
        ...
        for c in cause_list:
            if c in self.icd10_dict.keys():
                cause_stat_var += self.icd10_dict[c].title().replace(' ', '').replace(',', '_') + '_'
        ...
        if cause == 'C88_C90_C96':
            cause_stat_var = 'Other malignant neoplasm of lymphoid, haematopoietic and related tissue'.title().replace(
                ' ', '').replace(',', '_')
        combined_stat_var = ''
    ...
    def preprocess_data(self):
        ...
        if self.raw_df is None:
            raise ValueError("Uninitialized value of raw data frame. Please "
                             ...
                             "preprocess_data.")
        assert len(self.raw_df.columns) > 1, "Data must have at least two columns."
        ...
        self.preprocessed_df = self.raw_df.melt(id_vars=[self.raw_df.columns[0]])
        ...
        self.preprocessed_df.value = self.preprocessed_df.value.str.replace("([0-9:])$", lambda m: m.group(0) + ' ')
        statistical_variable = None
        # In case this returns only one element in the list.
        first_column_list = self.preprocessed_df.columns[0].rsplit(sep=",", maxsplit=1)
        ...
        if statistical_variable:
            split_df = self.preprocessed_df[self.preprocessed_df.columns[0]].str.rsplit(",", n=1, expand=True)
            self.preprocessed_df['statistical_variable'] = split_df[0]
            self.preprocessed_df['geo'] = split_df[1]
            self.preprocessed_df.drop(columns=[self.preprocessed_df.columns[0]], inplace=True)

        self.preprocessed_df = (self.preprocessed_df.set_index(["geo", "time"])
                                .pivot(columns="statistical_variable")['value']
                                .reset_index()
        ...
        self.preprocessed_df[self.preprocessed_df.columns[2:]] = self.preprocessed_df[
            self.preprocessed_df.columns[2:]].replace("([0-9:])$", lambda m: m.group(0) + ' ')
        ...
        for column_name in self.preprocessed_df.columns[2:]:
            self.preprocessed_df['{0}'.format(column_name)], self.preprocessed_df['{0}|notes'.format(column_name)] = (
                zip(*self.preprocessed_df[column_name].apply(lambda x: x.split(' '))))
    ...
    def clean_data(self):
        ...
        self.clean_df = self.preprocessed_df[self.preprocessed_df.columns[:len(
            self.preprocessed_df.columns) // 2 + 1]]  # number of columns should be 2 + 2X, we want the first 2 + X
        # columns
        ...
        for column in self.clean_df.columns[2:]:  # ignore geo and time
            stat_vars.append(
                self.translate_column(column))
            if stat_vars[-1][0] != '':
                stat_vars[-1][0] = 'Count_Death_' + stat_vars[-1][0] + '_AsFractionOf_Count_Person'
            else:
