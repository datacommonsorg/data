...
class CensusPrimaryCensusAbstractHouselessDataLoader(
    ...
    def _get_base_name(self, row):
        ...
        name = name + "_" + "Houseless"
        return name

    def _get_base_constraints(self, row):
        constraints = "livingInHouseholdType: Houseless \n"
        return constraints


if __name__ == '__main__':
    data_file_path = os.path.join(os.path.dirname(__file__),
                                  'data/PCA_HL_2011_Release.xls')
    #data_file_path = "https://censusindia.gov.in/2011-Documents/PCA_HL_2011_Release.xls"
    ...
    mcf_file_path = os.path.join(
        os.path.dirname(__file__),
        './IndiaCensus2011_Primary_Abstract_Houseless.mcf')
    tmcf_file_path = os.path.join(
        os.path.dirname(__file__),
        './IndiaCensus2011_Primary_Abstract_Houseless.tmcf')

    csv_file_path = os.path.join(
        os.path.dirname(__file__),
        './IndiaCensus2011_Primary_Abstract_Houseless.csv')
    loader = CensusPrimaryCensusAbstractHouselessDataLoader(
        ...
        census_year=2011,
        dataset_name="Primary_Abstract_Houseless")
    loader.process()
