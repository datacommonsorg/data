...
class ConvertResolvedLocationData:
    ...
    def __init__(self, census_data_dir, resolved_geos_file_name_pattern, census_location_to_dcid_json_file_pattern, census_year):    
    ...
    def _download(self):
        path = os.path.join(self.census_data_dir,self.resolved_geos_file_name_pattern.format(year=self.census_year))
    ...
    def generate_location_json(self):
        ...
        output_path = os.path.join(self.census_data_dir,self.census_location_to_dcid_json_file_pattern.format(year=self.census_year))
...
if __name__ == '__main__':
    ...
    census_year = 2011
    converter = ConvertResolvedLocationData(census_data_dir, resolved_geos_file_name_pattern, census_location_to_dcid_json_file_pattern, census_year)
