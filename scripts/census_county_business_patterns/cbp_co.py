...
class CBPCOProcessor:
  ...
  def process_co_data(self):
    ...
    with open(csv_path, 'w', newline='') as csv_f, \
      ...
      for r in rows:
        ...
        try:
          ...
          annual_payroll = int(self._lookup_col(r, self.ap_col)) * 1000 
          ...
          csv_writer.writerow(
              [geoid, yyyy, naics, est, emp, emp_nf, annual_payroll, ap_nf])
    ...
    logging.info('Finished processing. Wrote %d population nodes and %d observations.', count_pops, count_obs)
