...
def mcf_for(geoid, yyyy, naics, est, emp, ap):
  ...
  # annual_payroll
  obs_ap_list = new_observation(
      name=obs_est_name + '_annual_payroll',
  ...
  # Establishments
  obs_est_list = new_observation(
      name=obs_est_name + '_count',
      observed_node_name=pop_est_name,
      observation_date=yyyy,
  ...
  obs_emp_list = new_observation(
      name=obs_emp_name + '_count',
