...
class TestProcess(unittest.TestCase):
    ...
    def test_csv_mcf_tmcf_files(self):
        ...
        expected_csv_file_path = os.path.join(
            _EXPECTED_FILES_DIR, "us_nces_demographics_public_school.csv")

        expected_mcf_file_path = os.path.join(
            _EXPECTED_FILES_DIR, "us_nces_demographics_public_school.mcf")

        expected_tmcf_file_path = os.path.join(
            _EXPECTED_FILES_DIR, "us_nces_demographics_public_school.tmcf")
