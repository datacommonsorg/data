...
_PV_FORMAT_DENOMINATOR = lambda prop_val: f'"{prop_val[0]}": "dcs:Count_Student"' if 'None' not in prop_val[1] else ""
...
SV_PROP_ORDER = [
    "measuredProperty","populationType", "statType","race","schoolGradeLevel", "measurementDenominator"
]
...
FORM_STATVAR = {
    ...
    "schoolGradeLevel": {
        "regex": {
            "pattern": r"(SchoolGrade\d{,2}|Kindergarten|PreKindergarten)",
            "position": 1
        },
        "column": MELT_VAR_COL,
        "pv_format": _PV_FORMAT
    ...
    "measurementDenominator": {
        ...
        "column": MELT_VAR_COL,
        "pv_format": _PV_FORMAT_DENOMINATOR
    }
}