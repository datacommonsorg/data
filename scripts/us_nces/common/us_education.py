...
class USEducation:
    ...
    def _transform_public_place(self):
        ...
        #self._final_df_place["State_District_ID"] = self._final_df_place["State_District_ID"].astype(str).str.zfill(12)
    ...
    def _parse_file(self, raw_df: pd.DataFrame) -> pd.DataFrame:
        ...
        if self._import_name == "private_school":
            ...
            df_cleaned["School ID - NCES Assigned"] = df_cleaned[
                "School ID - NCES Assigned"].astype(str).str.zfill(12)
