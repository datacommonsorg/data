...
def set_flag():
	...
	flags.DEFINE_string('input_dir1', 'scripts/test_data/input/assembly_summary_refseq.txt',
                    'Output directory for generated files.')
	flags.DEFINE_string('tax_id_dcid_mapping', 'scripts/test_data/input/tax_id_dcid_mapping.txt',
                    'Input directory where .txt files downloaded.')
	_FLAGS(sys.argv)
