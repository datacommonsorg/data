...
class DivisionCls:
    ...
    def append_mcf_data(self, df: pd.DataFrame, mcf_file_path: str) -> None:
        """Append BiologicalTaxonomicDivision MCF entries to file
        and creates DIVISION dict
        ...
        for _, row in df.iterrows():
            ...
            try:
                ...
                if mapping_ncbi['replace_text']:
                    ...
                    TAX_ID_DCID_MAPPING[tax_id] = 'dcid:' + dcid
                else:
        ...
        with open(mcf_file_path, 'a') as file:
            ...
            for uh in sorted_lst:
                ...
                mcf_line = HOST_MCF.format(
                    biological_case_item=biological_case_item, item=uh)
                file.write(mcf_line)
    ...
    def append_mcf_data(self, df: pd.DataFrame, mcf_file_path: str) -> None:
        ...
        with open(mcf_file_path, 'a') as file:
            ...
            for ur in unique_rank:
                ...
                mcf_line = NODES_MCF.format(rank_case=rank_case, rank=ur)
                file.write(mcf_line)
