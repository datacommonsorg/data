...
EVIDENCE_MAP = {
    "IEA": "dcs:GeneOntologyEvidenceInferredFromElectronicAnnotation",
    "IDA": "dcs:GeneOntologyEvidenceInferredFromDirectAssay",
    "TAS": "dcs:GeneOntologyEvidenceTraceableAuthorStatement",
    "IPI": "dcs:GeneOntologyEvidenceInferredFromPhysicalInteraction",
    "IEP": "dcs:GeneOntologyEvidenceInferredFromExpressionPattern",
    "ISS": "dcs:GeneOntologyEvidenceInferredFromSequenceOrStructureSimilarity",
    "NAS": "dcs:GeneOntologyEvidenceNontraceableAuthorStatement",
    "IMP": "dcs:GeneOntologyEvidenceInferredFromMutantPhenotype",
    "ISA": "dcs:GeneOntologyEvidenceInferredFromSequenceAlignment",
    "HDA": "dcs:GeneOntologyEvidenceInferredFromHighThroughputDirectAssay",
    "EXP": "dcs:GeneOntologyEvidenceInferredFromExperiment",
    "ND": "dcs:GeneOntologyEvidenceNoBiologicalDataAvailable",
    "HEP": "dcs:GeneOntologyEvidenceInferredFromHighThroughputExpressionPattern",
    "IC": "dcs:GeneOntologyEvidenceInferredByCurator",
    "RCA": "dcs:GeneOntologyEvidenceInferredByReviewedComputationalAnalysis",
    "HMP": "dcs:GeneOntologyEvidenceInferredFromHighThroughputMutantPhenotype",
    "IGI": "dcs:GeneOntologyEvidenceInferredFromGeneticInteraction",
    "IKR": "dcs:GeneOntologyEvidenceInferredFromKeyResidues",
    "IGC": "dcs:GeneOntologyEvidenceInferredFromGenomicContext",
    "ISO": "dcs:GeneOntologyEvidenceInferredFromSequenceOrthology",
    "ISM": "dcs:GeneOntologyEvidenceInferredFromSequenceModel",
    "IBA": "dcs:GeneOntologyEvidenceInferredFromBiologicalAspectOfAncestor"
}

"""Mapping of qualifier values in file to qualifier enum."""
QUALIFIER_MAP = {
    "enables": "dcs:GeneOntologyQualifierEnables",
    "NOT|enables": "dcs:GeneOntologyQualifierNotEnables",
    "involved_in": "dcs:GeneOntologyQualifierInvolvedIn",
    "NOT|involved_in": "dcs:GeneOntologyQualifierNotInvolvedIn",
    "located_in": "dcs:GeneOntologyQualifierLocatedIn",
    "NOT|located_in": "dcs:GeneOntologyQualifierNotLocatedIn",
    "part_of": "dcs:GeneOntologyQualifierPartOf",
    "NOT|part_of": "dcs:GeneOntologyQualifierNotPartOf",
    "is_active_in": "dcs:GeneOntologyQualifierIsActiveIn",
    "NOT|is_active_in": "dcs:GeneOntologyQualifierNotIsActiveIn",
    "contributes_to": "dcs:GeneOntologyQualifierContributesTo",
    "NOT|contributes_to": "dcs:GeneOntologyQualifierNotContributesTo",
    "colocalizes_with": "dcs:GeneOntologyQualifierColocalizesWith",
    "NOT|colocalizes_with": "dcs:GeneOntologyQualifierNotColocalizesWith",
    "acts_upstream_of": "dcs:GeneOntologyQualifierActsUpstreamOf",
    "NOT|acts_upstream_of": "dcs:GeneOntologyQualifierNotActsUpstreamOf",
    "acts_upstream_of_or_within": "dcs:GeneOntologyQualifierActsUpstreamOfOrWithin",
    "NOT|acts_upstream_of_or_within": "dcs:GeneOntologyQualifierNotActsUpstreamOfOrWithin",
    "acts_upstream_of_positive_effect": "dcs:GeneOntologyQualifierActsUpstreamOfPositiveEffect",
    "NOT|acts_upstream_of_positive_effect": "dcs:GeneOntologyQualifierNotActsUpstreamOfPositiveEffect",
    "acts_upstream_of_or_within_positive_effect": "dcs:GeneOntologyQualifierActsUpstreamOfOrWithinPositiveEffect",
    "NOT|acts_upstream_of_or_within_positive_effect": "dcs:GeneOntologyQualifierNotActsUpstreamOfOrWithinPositiveEffect",
    "acts_upstream_of_negative_effect": "dcs:GeneOntologyQualifierActsUpstreamOfNegativeEffect",
    "NOT|acts_upstream_of_negative_effect": "dcs:GeneOntologyQualifierNotActsUpstreamOfNegativeEffect",
    "acts_upstream_of_or_within_negative_effect": "dcs:GeneOntologyQualifierActsUpstreamOfOrWithinNegativeEffect",
    "NOT|acts_upstream_of_or_within_negative_effect": "dcs:GeneOntologyQualifierNotActsUpstreamOfOrWithinNegativeEffect"
}
...
def main():
    ...
    combine_files(with_from, db_ref, cleaned_data, species, proteins, output_file)
...
def clean_data(file, species):
    ...
    file["DBObjectSymbolAssembly"] = file["DBObjectSymbol"].apply(map_gene_symbol, species = species)
...
def map_gene_symbol(symbol, species):
    ...
    """
    symbol = str(symbol)
    if species == "human" or species == "human_isoform":
    ...
    elif species == "chicken" or species == "chicken_isoform":
...
def get_db_references(file):
    ...
    split_db_ref.rename(columns = {"MGI":"MGI_DB", "PMID":"PMID_DB", "FB":"FB_DB", "ZFIN": "ZFIN_DB"}, inplace = True)
    return split_db_ref
...
def combine_files(with_from, db, file, species, proteins, output_file):
    """
    Args:
    ...
    merged = pd.merge(with_from, db, on = "index")
    merged = pd.merge(merged, file, on = "index")
    merged = merged.drop(['index', 'DBObjectSynonym', 'DBObjectSymbolAssembly', 'GOIDNumber'], axis = 1)
    if len(sys.argv) > 4:
        proteins = map_proteins(proteins)
        merged = pd.merge(merged, proteins, left_on = "DBObjectSymbol", right_on = "GeneSymbol", how = "left")
