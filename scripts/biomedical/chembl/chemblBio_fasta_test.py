...
Author: Suhana Bedi
Date: 07/09/2022
Name: chemblBio_fasta_test.py
Description: runs unit tests for format_chemblBio_fasta.py
Run: python3 chemblBio_fasta_test.py
'''
import unittest
from pandas.testing import assert_frame_equal 
from format_chemblBio_fasta import *
...
class TestParseMesh(unittest.TestCase): 
    ...
    def test_main(self):
        ...
        df_expected = pd.read_csv('test-data/chembl_29_bio_expected.csv')
        # Run all the functions in format_chemblBio_fasta.py
        df_actual = fasta_to_df('test-data/chembl_29_bio_test_data.fa') 
