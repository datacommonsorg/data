...
java -jar /Applications/datacommons-import-tool-0.1-alpha.1-jar-with-dependencies.jar lint tMCFs/codingGenes-knowledge.tmcf CSVs/codingGenes-knowledge.csv
...
java -jar /Applications/datacommons-import-tool-0.1-alpha.1-jar-with-dependencies.jar lint tMCFs/experiment.tmcf CSVs/codingGenes-experiments.csv
mv dc_generated experiment

java -jar /Applications/datacommons-import-tool-0.1-alpha.1-jar-with-dependencies.jar lint tMCFs/nonCodingGenes-knowledge.tmcf CSVs/nonCodingGenes-knowledge.csv
