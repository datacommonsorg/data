...
[`archived_emsembls_test.csv`](archived_emsembls_test.csv) subsetted only the Ensembl Protein IDs contained in [`actions_test.tsv`](actions_test.tsv) and [`protein_drug_interactions_test.tsv`](protein_drug_interactions_test.tsv)
