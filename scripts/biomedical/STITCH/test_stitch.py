...
class TestStitch(unittest.TestCase):
    ...
    def test_main(self):
        ...
        PATH_PROTEIN_INTERACTIONS = 'test-data/original_files/protein_drug_interactions_test.tsv'
        PATH_ACTIONS = 'test-data/original_files/actions_test.tsv'
        PATH_DRUG_INTERACTIONS = 'test-data/original_files/drug_interactions_test.tsv'
...
#         PATH_UNIPROT_MAPPING = 'test-data/original_files/uniprot_name_mapping.dat'
        archived_accessions_df=pd.read_csv('archived_uniprot_test.csv')
        uniprot_mapping_df=pd.read_csv('uniprot_id_mapping_test.csv')
        archived_ensembls_df=pd.read_csv('archived_ensembls_test.csv')
        
        PATH_SOURCES= 'test-data/original_files/sources_test.tsv'
        PATH_INCHIKEYS = 'test-data/original_files/inchikeys_test.tsv'
        PATH_CHEMICALS = 'test-data/original_files/chemicals_test.tsv'     
        ...
        drug_interactions_expected=pd.read_csv('test-data/drug_interactions_expected.csv')
        ...
        protein_drug_interactions_expected=pd.read_csv('test-data/protein_drug_interactions_expected.csv')        
        actions_df_expected = pd.read_csv('test-data/actions_expected.csv')
    
        # Run all the functions in compile_drugs.py 
        drug_df = compile_drug_info(PATH_SOURCES, PATH_INCHIKEYS, PATH_CHEMICALS)  
        drug_df_actual=drug_df.replace("", np.nan, regex=True)
        ...
        protein_drug_interactions_actual = protein_drug_interactions_actual.replace("", np.nan, regex = True)
        ...
        actions_df_actual = actions_df_actual.replace("", np.nan, regex = True)
