...
Author: Suhana Bedi
Date: 07/10/2021
Name: hmdb_extract.py
Description: Extracts the relevant tags and their corresponding 
information from the hmdb_metabolites xml file and converts it
into a cleaner and more readable csv file.
@file_output: csv output file 
"""
...
"""
Extracts relevant information from xml version of metabolites
file and converts it into a csv
Args:
    name = name of the xml file
    file = name of the resulting csv file 
Returns:
    output csv 
Source : http://www.metabolomics-forum.com/index.php?topic=1588.0
"""
...
def hmdbextract(name, file):
    ...
    for event, elem in context:
        ...
        try:
            ...
            pubchem = 'NA'
        try:
            phenol_explorer_compound_idt = elem.xpath(
...
def main():
    hmdbextract('hmdb_metabolites.xml', 'hmdb_metabolites.csv')
