...
Author: Khoa Hoang
Date: 08/11/2021
Name: format_genes.py
Description: This script formats genes.tsv and geneRoles.tsv files to
combine with tMCF files for import to data commons
@file_input: genes.tsv and geneRoles.tsv in human1 dataset
@file_output: formatted genes.csv and geneRoles.csv
'''
