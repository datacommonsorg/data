...
from process import USAirPollutionEmissionTrends
...
class TestProcess(unittest.TestCase):
    ...
    def test_mcf_tmcf_files(self):
        ...
        expected_mcf_file_path = os.path.join(
            EXPECTED_FILES_DIR, "airpollution_emission_trends_tier1.mcf")

        expected_tmcf_file_path = os.path.join(
            EXPECTED_FILES_DIR, "airpollution_emission_trends_tier1.tmcf")
