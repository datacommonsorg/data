...
from process import USCountyAirPollutionEmissionTrends
# pylint: enable=wrong-import-position

TEST_DATASET_DIR = os.path.join(MODULE_DIR, "test_files", "input_files")
EXPECTED_FILES_DIR = os.path.join(MODULE_DIR, "test_files", "expected_files")
...
class TestProcess(unittest.TestCase):
    ...
    def __init__(self, methodName: str = ...) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            base = USCountyAirPollutionEmissionTrends(self.ip_data,
    ...
    def test_mcf_tmcf_files(self):
        ...
        expected_mcf_file_path = os.path.join(
            EXPECTED_FILES_DIR,
            "expected_airpollution_emission_trends_county_tier1.mcf")

        expected_tmcf_file_path = os.path.join(
            EXPECTED_FILES_DIR,
            "expected_airpollution_emission_trends_county_tier1.tmcf")
    ...
    def test_create_csv(self):
        ...
        expected_csv_file_path = os.path.join(
            EXPECTED_FILES_DIR,
            "expected_airpollution_emission_trends_county_tier1.csv")
