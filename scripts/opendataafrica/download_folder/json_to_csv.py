...
def process_json_files(input_json_file, output_csv_file):
    ...
    try:
        ...
        try:
            ...
            logging.error(f"Error: Invalid JSON format in {input_json_file}.")
        except Exception as e:
            logging.error(
                f"An unexpected error occurred while processing {input_json_file}: {e}"
            )

    except FileNotFoundError:
        logging.fatal(f"Error: Folder '{input_json_file}' not found.")
    except Exception as e:
