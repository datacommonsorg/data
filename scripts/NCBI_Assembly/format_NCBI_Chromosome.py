...
def write_genome_assembly(file_output, dict_genome_assembly, genome, 
	...
	'Organismname': 'ofSpecies'}  # convert NCBI fields to property names
	list_key_enums = ['Assemblytype', 'Releasetype', 'RefSeqcategory', \
	'Assemblylevel']
...
def write_chromosome(line, file_output, genome):
	...
	'MT']  # list of known defined chromosomes
	w = open(file_output, mode='a')
...
def main():
	...
	for line in f:
		...
		elif line[0].startswith('##') and len(line) == 3 and 'Accession' not in\
		line[1]:
