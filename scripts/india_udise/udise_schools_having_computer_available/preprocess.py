...
"""Classes and methods to import Number of Schools having Computer Available from Unified District Information System for Education (UDISE)"""
...
class UDISESchoolsHavingComputerAvailable(UDISEIndiaSchoolDataLoaderBase):
    ...
    def _get_base_constraints(self, data_row):
        constraints = []
        constraints.append("amenity: dcs:Computer")
        return constraints
...
if __name__ == "__main__":
    ...
    csv_file_path = os.path.join(
        module_dir_, "UDISEIndia_Schools_Having_Computer_Available.csv")
    mcf_file_path = os.path.join(
        module_dir_, "UDISEIndia_Schools_Having_Computer_Available.mcf")
