...
#### Cleaned Data
Cleaned data will be inside [UDISEIndia_Schools_Having_Computer_Available.zip](UDISEIndia_Schools_Having_Computer_Available.zip) as a CSV file with the following columns.
...
- [UDISEIndia_Schools_Having_Computer_Available.mcf](UDISEIndia_Schools_Having_Computer_Available.mcf)
- [UDISEIndia_Schools_Having_Computer_Available.tmcf](UDISEIndia_Schools_Having_Computer_Available.tmcf)
...
```bash
python3 -m unittest india_udise.udise_schools_having_computer_available.preprocess_test.TestPreprocess
```

### Import Procedure

The below script will download the data
`python -m india_udise.udise_schools_having_computer_available.preprocess download`

The below script will generate csv and mcf files.
`python -m india_udise.udise_schools_having_computer_available.preprocess process`
