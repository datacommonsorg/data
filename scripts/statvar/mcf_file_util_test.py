...
class TestMCFFileUtil(unittest.TestCase):
    ...
    def test_load_mcf_file(self):
        mcf_nodes = mcf_file_util.load_mcf_nodes(
            os.path.join(_module_dir_, 'test_data', 'sample_output.mcf'))
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
          ...
          mcf_file_util.write_mcf_nodes(node_dicts = [{ dcid: new_node }],
          ...
          self.assertEqual(expected_node, mcf_nodes[dcid])
