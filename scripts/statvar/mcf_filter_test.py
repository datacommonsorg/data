...
class TestMCFFilter(unittest.TestCase):
    ...
    def test_filter_mcf_file(self):
        ...
        source_mcf = os.path.join(_TEST_DIR, 'india_census_sample_output.mcf')
        exclude_mcf = os.path.join(_TEST_DIR, 'us_census_B01001_output.mcf')
        ...
        filtered_mcf = os.path.join(_TEST_DIR, 'sample_filtered.mcf')
    ...
    def test_drop_existing_mcf_nodes(self):
        ...
        self.assertEqual(filtered_nodes['dcid:Count_Person_Test'],
