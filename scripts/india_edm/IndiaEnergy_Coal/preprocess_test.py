...
class TestPreprocess(unittest.TestCase):
    ...
    def create_test_output(self):    
        expected_file = open(os.path.join(module_dir, 'test_data/expected_output.csv'))
        ...
        self.final_csv.to_csv(os.path.join(module_dir, 'test_data/test_output.csv'),
                              index=False)
        
        result_file = open(os.path.join(module_dir, 'test_data/test_output.csv'))
