...
def main():
    ...
    csv_paths = ["./dpc-covid19-ita-national-trend.csv",\
               "./dpc-covid19-ita-province.csv",\
               "./dpc-covid19-ita-regional.csv"]
    tmcf_paths = ["./dpc-covid19-ita-national-trend.tmcf",\
               "./dpc-covid19-ita-province.tmcf",\
               "./dpc-covid19-ita-regional.tmcf"]
