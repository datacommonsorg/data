...
def generate_cleaned_dataframe():
  ...
  series_desc = pd.read_csv("https://download.bls.gov/pub/time.series/jt/jt.series", sep="\s+")
  assert len(series_desc.columns) == len(expected_series_columns) and False not in (series_desc.columns == expected_series_columns)
  ...
  job_openings = pd.read_csv("https://download.bls.gov/pub/time.series/jt/jt.data.2.JobOpenings", sep="\s+")
  job_hires = pd.read_csv("https://download.bls.gov/pub/time.series/jt/jt.data.3.Hires", sep="\s+")
  total_seps = pd.read_csv("https://download.bls.gov/pub/time.series/jt/jt.data.4.TotalSeparations", sep="\s+")
  total_quits = pd.read_csv("https://download.bls.gov/pub/time.series/jt/jt.data.5.Quits", sep="\s+")
  total_layoffs = pd.read_csv("https://download.bls.gov/pub/time.series/jt/jt.data.6.LayoffsDischarges", sep="\s+")
  total_other_seps = pd.read_csv("https://download.bls.gov/pub/time.series/jt/jt.data.7.OtherSeparations", sep="\s+")
  ...
  for schema_name, population_type, job_change_event, df in schema_mapping:
    ...
    assert len(df.columns) == len(expected_job_columns) and False not in (df.columns == expected_job_columns)
