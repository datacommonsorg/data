...
class CovidHarvard:
    def __init__(self, confirmed_cumulative_csv: str, deaths_cumulative_csv: str, region: str):
        ...
        confirmed_cumulative_df = self.convert_fips_to_geoId(confirmed_cumulative_df, region)
        deaths_cumulative_df = self.convert_fips_to_geoId(deaths_cumulative_df, region)
    ...
    def drop_unecessary_columns(self, df: pd.DataFrame) -> pd.DataFrame:
    ...
    def combine_dfs(self, confirmed_cumulative, deaths_cumulative: pd.DataFrame):
