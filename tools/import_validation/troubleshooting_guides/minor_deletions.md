...
1. **Locate the Textproto File:** To find out exactly where the data came from, check the file <import_name>.textproto file in Google's internal code base. For EurostatData_Fertility, the file path is: `datacommons/import/mcf/manifest/international_stats/EurostatData_Fertility.textproto`
