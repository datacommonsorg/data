...
- svobs\_diff\_summary.csv: diff summary for observation analysis
- svobs\_diff\_samples.csv: sample diff for observation analysis
- svobs\_diff\_log.csv: diff log for observations
