...
"""Hermetic unit tests for Zurich bev_3903_all generate_rollups module."""
...
class GenerateRollupsTest(unittest.TestCase):
    """Unit test suite for bev_3903_all generate_rollups preprocessor."""
    ...
    def test_process_rollups_generates_all_demographic_and_spatial_slices(self):
        ...
        # Total for Ganze Stadt should sum all rows (10 + 20 = 30)
        ...
        self.assertEqual(city_total.iloc[0]['AnzBestWir'], 30)

        # Total for Kreis 1 should also be 30
    ...
    def test_process_rollups_numeric_coercion(self):
        ...
        data = pd.DataFrame({
            ...
            'KreisLang': ['Kreis 1', 'Kreis 1'],
            'AlterV10Kurz': ['0-9', '0-9'],
            'SexKurz': ['M', 'M'],
            'HerkunftLang': ['Schweizer*in', 'Schweizer*in'],
            'AnzBestWir': ['15', 'invalid']
        })
    ...
    def test_process_rollups_missing_columns_raises(self):
        ...
        df_missing = pd.DataFrame({'StichtagDatJahr': [2025]})
