...
curl -L --retry 3 "https://ec.europa.eu/eurostat/api/dissemination/sdmx/2.1/data/une_rt_a/?format=SDMX-CSV&compressed=false" -o input_files/unemployment_by_sex_and_age_annual_data_data_raw.csv
