...
curl -L --retry 3 "https://ec.europa.eu/eurostat/api/dissemination/sdmx/2.1/data/une_rt_m/?format=SDMX-CSV&compressed=false" -o unemployment_by_sex_and_age_monthly_data_data_raw.csv
