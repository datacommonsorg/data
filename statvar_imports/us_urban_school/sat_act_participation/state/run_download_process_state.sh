...
python3 download_statelevel.py 
...
process_files() {
    ...
    mkdir -p output_files_state

    # Loop through all SAT/ACT participation files in the input directory.
    for input_file in input_files_state/*_sat_act_participation.*; do
        ...
        CMD="python3 ../../../../tools/statvar_importer/stat_var_processor.py \
            ...
            --pv_map=config/SATorACT_Participation_pvmap.csv \
            --config_file=config/SATorACT_Participation_metadata.csv \
