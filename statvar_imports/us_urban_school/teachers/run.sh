...
# --- 3. Process 2018 onwards Files (Comma-separated CSVs, excluding 2016) ---
...
--config_file="$SCRIPT_PATH/metadata.csv" \
--existing_statvar_mcf=gs://unresolved_mcf/scripts/statvar/stat_vars.mcf \
--output_path="$SCRIPT_PATH/output_files/teachers_and_staff_2018_2024_output" \
--output_counters="$SCRIPT_PATH/counters/teachers_and_staff_2018_2024_counters.csv" \
--log_level=-2 \
--log_every_n=1000 || \
{ echo "Error: Processing teachers_and_staff files for the year 2018 to 2024 failed!"; exit 1; }
