...
def download_data(download_folder_name, reg_key, bls_ces_url, 
    ...
    try:
        ...
        source_data_folder = source_data_folder = os.path.join(download_folder_name, _FLAGS.source_folder)
    ...
    # 'SMS72000005552000001',
    # 'SMS72000005553000001',
    # 'SMS72000006000000001',
    # 'SMS72000006054000001',
    # 'SMS72000006056000001',
    # 'SMS72000006500000001',
    # 'SMS72000006561000001',
    # 'SMS72000006562000001']
        ...
        for i in range(0, len(series_id), chunk_size):
            ...
            data = json.dumps({
                ...
                "registrationkey": "2812536d5f074154839cd5e684a72789"
            })
            try:
...
def main(argv):
    logging.info("Start..")
    state_start_year = '2020'
    national_start_year = '2015'
    try:
        ...
        if _FLAGS.place_type == "state":
            ...
            download_data(download_folder_name, reg_key, bls_ces_url, 
                          series_if_file_name, state_start_year)
            ...
            download_data(download_folder_name, reg_key, bls_ces_url, 
                          series_if_file_name, national_start_year)
            convert_to_raw_csv(download_folder_name, source_data_folder)
            merge_all_csvs(download_folder_name)
            logging.info("Completed...")
