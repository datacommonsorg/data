...
class TestFileSharder(unittest.TestCase):
    ...
    def test_shard_csv_file(self):
        ...
        # Verify output files
        shard_0_path = os.path.join(self.test_dir.name, 'output-00000-of-00003.csv')
        shard_1_path = os.path.join(self.test_dir.name, 'output-00001-of-00003.csv')
        shard_2_path = os.path.join(self.test_dir.name, 'output-00002-of-00003.csv')
    ...
    def test_shard_mcf_file(self):
        ...
        # Verify output files
        shard_0_path = os.path.join(self.test_dir.name, 'output-00000-of-00003.mcf')
        shard_1_path = os.path.join(self.test_dir.name, 'output-00001-of-00003.mcf')
        shard_2_path = os.path.join(self.test_dir.name, 'output-00002-of-00003.mcf')
    ...
    def test_skip_duplicates(self):
        ...
        shard_0_path = os.path.join(self.test_dir.name, 'output-00000-of-00002.csv')
        shard_1_path = os.path.join(self.test_dir.name, 'output-00001-of-00002.csv')
